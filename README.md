...
```
babeltrace bash bash-completion bc build-essential coreutils curl distro-info file findutils jq libbrotli-dev lldb lttng-tools sed strace npm postgresql unixodbc zlib1g-dev
```
